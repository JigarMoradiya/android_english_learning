...
private val rControlledAccentColor = Color(0xFF2E7D32)
private val bossyRColor = Color(0xFFC62828)

@Composable
fun RControlledIntroPage(navController: NavController) {
        ...
        BoxWithConstraints(
            ...
            Row(modifier = Modifier.fillMaxSize()) {
                ...
                Column(
                    ...
                    Column(
                        ...
                        Text(
                            ...
                            color = rControlledAccentColor
                        )
                        Text(
                            text = "Meet the Bossy R! 👑",
                ...
                PhonicsIntroRightPanel(
                    ...
                    strokeColor = rControlledAccentColor,
                    title = "R changes how\nvowels sound!",
                    titleColor = rControlledAccentColor,
                    descLine1 = "When R follows a vowel",
                    descLine2 = "it takes control of the sound",
                    learnButton = PhonicsIntroBtnConfig(
                        text = "Learn Words",
                        icon = Icons.Default.MenuBook,
                        type = ButtonType.PURPLE,
                        onClick = { navController.navigate(RouteNavigation.RControlledLearn.route) }
                    ),
                    practiceButton = PhonicsIntroBtnConfig(
                        text = "Practice",
                        icon = Icons.Default.CheckCircle,
                        type = ButtonType.BLUE,
                        onClick = { navController.navigate(RouteNavigation.RControlledPractice.route) }
                    ),
...
@Composable
private fun RControlledIntroRow(emoji: String, text: String) {
    Row(
