...
private val diphthongsAccentColor = Color(0xFFE65100)

@Composable
fun DiphthongsIntroPage(navController: NavController) {
        ...
        BoxWithConstraints(
            ...
            Row(modifier = Modifier.fillMaxSize()) {
                ...
                Column(
                    ...
                    Column(
                        ...
                        Text(
                            ...
                            color = diphthongsAccentColor
                        )
                        Text(
                            text = "Sound Sliders 🎢",
                            style = MaterialTheme.typography.titleMedium.scaled(),
                            fontWeight = FontWeight.Bold,
                            color = diphthongsAccentColor.copy(alpha = 0.75f)
                        )
                        ...
                        Column(verticalArrangement = Arrangement.spacedBy(Dimens8)) {
                            diphthongGroups.forEach { group ->
                                Row(
                                    ...
                                    modifier = Modifier
                                        .background(group.accentColor.copy(alpha = 0.10f), RoundedCornerShape(50))
                                    ...
                                    Text(
                                        text = group.words.firstOrNull()?.word ?: "",
                                        style = MaterialTheme.typography.bodySmall.scaled(),
                                        fontWeight = FontWeight.Bold,
                        ...
                        // Description bullets
                        Column(verticalArrangement = Arrangement.spacedBy(Dimens8)) {
                            DiphthongsIntroRow("🎢", "Two vowels slide together into one sound")
                            DiphthongsIntroRow("🔊", "The sound glides from one position to another")
                ...
                PhonicsIntroRightPanel(
                    ...
                    strokeColor = diphthongsAccentColor,
                    title = "Two vowels slide\ninto one sound!",
                    titleColor = diphthongsAccentColor,
                    descLine1 = "Learn oi/oy, ou/ow, and au/aw",
                    descLine2 = "and hear how vowels glide together",
                    learnButton = PhonicsIntroBtnConfig(
                        text = "Learn Words",
                        icon = Icons.Default.MenuBook,
                        type = ButtonType.PURPLE,
                        onClick = { navController.navigate(RouteNavigation.DiphthongsLearn.route) }
                    ),
                    practiceButton = PhonicsIntroBtnConfig(
                        text = "Practice",
                        icon = Icons.Default.CheckCircle,
                        type = ButtonType.BLUE,
                        onClick = { navController.navigate(RouteNavigation.DiphthongsPractice.route) }
                    ),
...
@Composable
private fun DiphthongsIntroRow(emoji: String, text: String) {
    Row(
