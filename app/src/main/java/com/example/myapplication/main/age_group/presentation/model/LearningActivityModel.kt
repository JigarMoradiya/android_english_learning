...
val activities_age_3_5 = listOf(
    LearningActivityModel(R.string.alphabet_tracing,          R.drawable.age_3_5_alphabet_tracing_icon,          RouteNavigation.AlphabetTracing.route,          moduleId = ModuleID.ALPHABET_TRACING),
    LearningActivityModel(R.string.letter_recognition,        R.drawable.age_3_5_letter_recognition_icon,        RouteNavigation.LetterRecognition.route,         moduleId = ModuleID.LETTER_RECOGNITION),
    LearningActivityModel(R.string.abcd_with_images,          R.drawable.age_3_5_abcd_images_icon,               RouteNavigation.ABCDWithImages.route,            moduleId = ModuleID.ABCD_WITH_IMAGES),
    LearningActivityModel(R.string.coloring_alphabet,         R.drawable.age_3_5_coloring_alphabets_icon,        RouteNavigation.ColoringAlphabets.route,         moduleId = ModuleID.COLORING_ALPHABETS),
    LearningActivityModel(R.string.match_letters,             R.drawable.age_3_5_match_letters_icon,             RouteNavigation.MatchLetters.route,              moduleId = ModuleID.MATCH_UPPER_LOWER),
    LearningActivityModel(R.string.fill_the_blank,            R.drawable.age_3_5_fill_the_blank_icon,            RouteNavigation.FillTheBlankLetters.route,       moduleId = ModuleID.FILL_THE_BLANK_LETTER),
    LearningActivityModel(R.string.arrange_letter_in_sequence,R.drawable.age_3_5_arrange_letters_in_sequence_icon,RouteNavigation.ArrangeLetterInSequence.route,  moduleId = ModuleID.ARRANGE_LETTER_SEQUENCE),
    LearningActivityModel(R.string.match_letter_image,        R.drawable.age_3_5_match_letter_image_icon,        RouteNavigation.MatchLetterWithImage.route,      moduleId = ModuleID.MATCH_LETTER_WITH_IMAGE),
    LearningActivityModel(R.string.missing_letter,            R.drawable.age_3_5_missing_letter_icon,            RouteNavigation.MissingLetterEasy.route,         moduleId = ModuleID.MISSING_LETTER),
    LearningActivityModel(R.string.drag_drop_words,           R.drawable.age_3_5_drag_drop_word_icon,            RouteNavigation.DragDropWord.route,              moduleId = ModuleID.DRAG_DROP_LETTERS),
)
...
val activities_age_5_7 = listOf(
    ...
    LearningActivityModel(R.string.opposite_words,         R.drawable.age_5_7_match_word_image,     RouteNavigation.OppositeWords.route,            Color(0xFF9929EA), moduleId = ModuleID.OPPOSITES_WORD),
    LearningActivityModel(R.string.singular_plural,        R.drawable.age_5_7_word_jigsaw,          RouteNavigation.SingularPlural.route,           Color(0xFFF97A00), moduleId = ModuleID.SINGULAR_PLURAL),
//    LearningActivityModel(R.string.coloring_word,        R.drawable.age_5_7_coloring_word,        RouteNavigation.ColoringWord.route,             Color(0xFF3E5F44), moduleId = ModuleID.COLORING_WORDS),
    ...
    LearningActivityModel(R.string.match_letters,          R.drawable.age_5_7_missing_letter,       RouteNavigation.MissingLetterMedium.route,      Color(0xFFF97A00), moduleId = ModuleID.MISSING_LETTER_57),
    ...
    LearningActivityModel(R.string.sight_words,            R.drawable.age_5_7_sight_words_title,    RouteNavigation.SightWords.route,               Color(0xFF7C4585), moduleId = ModuleID.SIGHT_WORDS),
...
val activities_age_6_8 = listOf(
    ...
    LearningActivityModel(R.string.sentenceCheck,         R.drawable.age_6_8_sentence_check,           RouteNavigation.SentenceUnitList.sentenceUnitList(UnitSelectionScreen.SENTENCE_CHECK.name),           Color(0xFFFF9D00), moduleId = ModuleID.SENTENCE_CHECK),
