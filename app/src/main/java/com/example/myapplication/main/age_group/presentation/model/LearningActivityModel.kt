...
val activities_age_3_5 = listOf(
    ...
    LearningActivityModel(R.string.fill_the_blank, R.drawable.age_3_5_fill_the_blank_icon,RouteNavigation.FillTheBlankLetters.route),
    LearningActivityModel(R.string.arrange_letter_in_sequence, R.drawable.age_3_5_arrange_letters_in_sequence_icon,RouteNavigation.ArrangeLetterInSequence.route),
