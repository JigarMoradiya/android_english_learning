...
val activities_age_3_5 = listOf(
    ...
    LearningActivityModel(R.string.fill_the_blank, R.drawable.age_3_5_match_letters_icon,RouteNavigation.FillTheBlankLetters.route),
    LearningActivityModel(R.string.arrange_letter_in_sequence, R.drawable.age_3_5_match_letters_icon,RouteNavigation.ArrangeLetterInSequence.route),
