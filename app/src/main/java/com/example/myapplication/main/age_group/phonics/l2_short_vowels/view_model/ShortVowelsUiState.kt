...
val shortVowelData = listOf(
    ShortVowelModel(
        vowel = "A", label = "/a/ as in...", soundWord = "aah",
    ...
    ShortVowelModel(
        vowel = "E", label = "/e/ as in...", soundWord = "eh",
    ...
    ShortVowelModel(
        vowel = "I", label = "/i/ as in...", soundWord = "ih",
    ...
    ShortVowelModel(
        vowel = "O", label = "/o/ as in...", soundWord = "oh",
    ...
    ShortVowelModel(
        vowel = "U", label = "/u/ as in...", soundWord = "uh",
