...
import com.example.myapplication.main.age_group.phonics.l14_diphthongs.view_model.DiphthongsPracticeQuestion
import com.example.myapplication.main.age_group.phonics.l14_diphthongs.view_model.DiphthongsPracticeUiState
import com.example.myapplication.main.age_group.phonics.l14_diphthongs.view_model.DiphthongsPracticeViewModel
...
private fun groupForDiphthong(diphthong: String) =
    diphthongGroups.find { it.spellings.contains(diphthong) }

@Composable
fun DiphthongsPracticePage(navController: NavController) {
    val viewModel: DiphthongsPracticeViewModel = hiltViewModel()
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        if (uiState.isFinished) {
            DiphthongsPracticeFinishedView(
                score = uiState.score,
...
@Composable
private fun DiphthongsPracticeLeftPanel(
    question: DiphthongsPracticeQuestion,
    uiState: DiphthongsPracticeUiState,
    total: Int,
    onBack: () -> Unit,
    modifier: Modifier
) {
    Column(modifier = modifier) {
        BackButtonWithText(title = "Diphthongs", onBackClick = onBack)
        ...
        Column(
            ...
            Column(
                ...
                Text(
                    text = "Fill the Diphthong!",
                    style = MaterialTheme.typography.titleLarge.scaled(),
                    fontWeight = FontWeight.Bold,
                    color = practiceAccentColor
                )
                Text(
                    text = "Which sound fits in '${question.displayWord}'?",
...
@Composable
private fun DiphthongsPracticeRightPanel(
    question: DiphthongsPracticeQuestion,
    uiState: DiphthongsPracticeUiState,
    ...
    Column(
        ...
        question.options.forEach { option ->
            DiphthongsOptionTile(
                option = option,
                correctDiphthong = question.correctDiphthong,
                uiState = uiState,
...
@Composable
private fun DiphthongsOptionTile(
    option: String,
    correctDiphthong: String,
    uiState: DiphthongsPracticeUiState,
    onTap: () -> Unit,
    modifier: Modifier
) {
    ...
    val isCorrect = option == correctDiphthong
    val group = groupForDiphthong(option)
...
@Composable
private fun DiphthongsPracticeFinishedView(score: Int, total: Int, onRestart: () -> Unit) {
