package com.example.myapplication.main.age_group.from_5_to_7.drag_and_drop_word
...
import com.example.myapplication.main.age_group.from_5_to_7.drag_and_drop_word.components.DragDropScreen
...
@Composable
fun DragDropWordPage57(
    navController: NavController,
    difficultyLevel: DifficultyLevel,
    viewModel: DragDropWordViewModel57 = hiltViewModel()
) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Box(modifier = Modifier.fillMaxSize().windowInsetsPadding(WindowInsets.safeDrawing)) {
            ...
            DragDropScreen(viewModel, modifier = Modifier.fillMaxSize())
