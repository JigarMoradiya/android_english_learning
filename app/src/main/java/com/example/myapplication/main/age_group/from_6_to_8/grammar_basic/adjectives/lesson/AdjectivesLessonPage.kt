...
@Composable
fun AdjectivesLessonPage(
    navController: NavController,
    viewModel: AdjectivesLessonViewModel = hiltViewModel()
) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            // Header
            GrammarLessonHeader(
                title = stringResource(R.string.adjective_title),
                onBackClick = {
                    navController.popBackStack()
                },
                onPracticeClick = {
                    navController.navigate(RouteNavigation.GrammarBasicAdjectivesPractice.route)
                }
            )
