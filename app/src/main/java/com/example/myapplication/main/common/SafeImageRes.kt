...
import com.example.myapplication.data.generation.letter.ImageLetterArrowMapper
...
@Composable
fun getImageResForLetterArrow(imgName: String?): Int? {
    if (imgName.isNullOrBlank()) return null
    return ImageLetterArrowMapper.get(imgName)
}
@Composable
