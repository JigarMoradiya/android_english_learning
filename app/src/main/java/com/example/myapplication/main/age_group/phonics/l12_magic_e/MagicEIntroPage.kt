...
@Composable
fun MagicEIntroPage(navController: NavController) {
        ...
        BoxWithConstraints(
            ...
            Row(modifier = Modifier.fillMaxSize()) {
                ...
                Column(
                    ...
                    Column(
                                    ...
                                    Text(
                                        text = buildAnnotatedString {
                                            withStyle(SpanStyle(color = color)) {
                                                append(magic.dropLast(1))
                                            }
                                            withStyle(SpanStyle(color = magicEAccentColor)) {
                                                append("e")
                                            }
                                        },
                                        style = MaterialTheme.typography.labelMedium.scaled(),
                        ...
                        Column(verticalArrangement = Arrangement.spacedBy(Dimens8)) {
                            MagicEIntroRow("🪄", "Silent E at the end changes the vowel")
                            MagicEIntroRow("🔊", "Short vowel becomes LONG — says its name!")
                ...
                PhonicsIntroRightPanel(
                    ...
                    strokeColor = magicEAccentColor,
                    title = "Silent E makes the\nvowel say its name!",
                    titleColor = magicEAccentColor,
                    descLine1 = "Add E at the end of a word",
                    descLine2 = "and the middle vowel becomes LONG",
                    learnButton = PhonicsIntroBtnConfig(
                        text = "Learn Words",
                        icon = Icons.Default.MenuBook,
                        type = ButtonType.PURPLE,
                        onClick = { navController.navigate(RouteNavigation.MagicELearn.route) }
                    ),
                    practiceButton = PhonicsIntroBtnConfig(
                        text = "Practice",
                        icon = Icons.Default.CheckCircle,
                        type = ButtonType.BLUE,
                        onClick = { navController.navigate(RouteNavigation.MagicEPractice.route) }
                    ),
...
@Composable
private fun MagicEIntroRow(emoji: String, text: String) {
    Row(
