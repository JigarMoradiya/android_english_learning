package com.example.myapplication.main.age_group.from_6_to_8.grammar_basic.verb.lesson
...
fun VerbLessonPage(
    ...
    viewModel: VerbLessonViewModel = hiltViewModel()
) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            // Header
            GrammarLessonHeader(
                title = stringResource(R.string.verb_title),
                onBackClick = {
                    navController.popBackStack()
                },
                onPracticeClick = {
                    navController.navigate(RouteNavigation.GrammarBasicVerbPractice.route)
                }
            )
